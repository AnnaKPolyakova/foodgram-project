# Generated by Django 3.2.3 on 2021-06-08 08:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RecipeTegRelation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='recipes.recipe', verbose_name='Рецепт')),
                ('teg', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='recipes.teg', verbose_name='Рецепт')),
            ],
            options={
                'verbose_name': 'Тег',
                'verbose_name_plural': 'Теги',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ingredient_order', models.PositiveIntegerField(default=0)),
        ...
        migrations.AddField(
            model_name='recipe',
            name='teg',
            field=models.ManyToManyField(help_text='Добавьте тег (один или несколько).', related_name='teg', through='recipes.RecipeTegRelation', to='recipes.Teg', verbose_name='Тег'),
        ),
        migrations.AddField(
